; (function ($) {
    ...
    $(document).on("click", ".all-demo", function () {
        ...
        if (!themeDemosObj.hasClass("active")) {
            ...
            var scrollOptions =
                themeDemosScrollObj.attr("data-scroll-options") || '{ "theme": "dark" }'
            if (typeof scrollOptions !== "undefined" && scrollOptions !== null) {
                scrollOptions = $.parseJSON(scrollOptions)
    ...
    const smallNumberOfOptions = 14
    const medNumberOfOptions = 9
    const largeNumberOfOptions = 7
    ...
    let oneOnOneLeadershipCoaching = false;

    $("#oneOnOneLeadershipCoaching").on('click', function () {
        if (!oneOnOneLeadershipCoaching) {
            oneOnOneLeadershipCoaching = true
            medNumberOfSelected += 1
            $("#oneOnOneLeadershipCoaching-circle").addClass('d-none')
            $("#oneOnOneLeadershipCoaching-check").removeClass('d-none')
        } else {
            oneOnOneLeadershipCoaching = false
            medNumberOfSelected -= 1
            $("#oneOnOneLeadershipCoaching-circle").removeClass('d-none')
            $("#oneOnOneLeadershipCoaching-check").addClass('d-none')
        }
    })
    ...
    const selectEmployee = (el) => {
        $(`#${lastSelectedEmplyoee}`).addClass("btn-odg-color");
        $(`#${lastSelectedEmplyoee}`).removeClass("btn-odg-color-selected");
        $(`#${el}`).removeClass("btn-odg-color");
        $(`#${el}`).addClass("btn-odg-color-selected");

        lastSelectedEmplyoee = el
    }

    // employess button group 
    $("#employees-1").on('click', function () {
        selectEmployee('employees-1')
        assessmentAnswers.employees = "1-4 employees"
    })
    $("#employees-2").on('click', function () {
        selectEmployee('employees-2')
        assessmentAnswers.employees = "5-200 employees"
    })
    $("#employees-3").on('click', function () {
        selectEmployee('employees-3')
        assessmentAnswers.employees = "201-1000 employees"
    })
    $("#employees-4").on('click', function () {
        selectEmployee('employees-4')
        assessmentAnswers.employees = "1001-2000 employees"
    })
    $("#employees-5").on('click', function () {
        selectEmployee('employees-5')
        assessmentAnswers.employees = "2001+ employees"
    })

    // Revenue Range func
    const selectRevenue = (el) => {
        $(`#${lastRevenueRange}`).addClass("btn-odg-color");
        $(`#${lastRevenueRange}`).removeClass("btn-odg-color-selected");
        $(`#${el}`).removeClass("btn-odg-color");
        $(`#${el}`).addClass("btn-odg-color-selected");

        lastRevenueRange = el
    }
    // Revenue Range button group 
    $("#revenue-1").on('click', function () {
        selectRevenue('revenue-1')
        assessmentAnswers.revenue = "0-250k"
    })
    $("#revenue-2").on('click', function () {
        selectRevenue('revenue-2')
        assessmentAnswers.revenue = "250k-3mm"
    })
    $("#revenue-3").on('click', function () {
        selectRevenue('revenue-3')
        assessmentAnswers.revenue = "3mm-30mm"
    })
    $("#revenue-4").on('click', function () {
        selectRevenue('revenue-4')
        assessmentAnswers.revenue = "30mm-100mm"
    })
    $("#revenue-5").on('click', function () {
        selectRevenue('revenue-5')
        assessmentAnswers.revenue = "100mm +"
    })


    // func Yrs in Business
    const selectYrsInBusiness = (el) => {
        $(`#${lastYrsinBusiness}`).addClass("btn-odg-color");
        $(`#${lastYrsinBusiness}`).removeClass("btn-odg-color-selected");
        $(`#${el}`).removeClass("btn-odg-color");
        $(`#${el}`).addClass("btn-odg-color-selected");

        lastYrsinBusiness = el
    }
    // Yrs in Business button group 
    $("#yrsInBusiness-1").on('click', function () {
        selectYrsInBusiness('yrsInBusiness-1')
        assessmentAnswers.yrsInBusiness = "0-2 yrs"
    })
    $("#yrsInBusiness-2").on('click', function () {
        selectYrsInBusiness('yrsInBusiness-2')
        assessmentAnswers.yrsInBusiness = "3-5 yrs"
    })
    $("#yrsInBusiness-3").on('click', function () {
        selectYrsInBusiness('yrsInBusiness-3')
        assessmentAnswers.yrsInBusiness = "6-10 yrs"
    })
    $("#yrsInBusiness-4").on('click', function () {
        selectYrsInBusiness('yrsInBusiness-4')
        assessmentAnswers.yrsInBusiness = "11+ yrs"
    })

    // Senior Leaders func
    const selectSeniorLeaders = (el) => {
        $(`#${lastSeniorLeaders}`).addClass("btn-odg-color");
        $(`#${lastSeniorLeaders}`).removeClass("btn-odg-color-selected");
        $(`#${el}`).removeClass("btn-odg-color");
        $(`#${el}`).addClass("btn-odg-color-selected");

        lastSeniorLeaders = el
    }
    // Senior Leaders button group 
    $("#seniorLeaders-1").on('click', function () {
        selectSeniorLeaders('seniorLeaders-1')
        assessmentAnswers.seniorLeaders = "1 senior leader"
    })
    $("#seniorLeaders-2").on('click', function () {
        selectSeniorLeaders('seniorLeaders-2')
        assessmentAnswers.seniorLeaders = "2 senior leaders"
    })
    $("#seniorLeaders-3").on('click', function () {
        selectSeniorLeaders('seniorLeaders-3')
        assessmentAnswers.seniorLeaders = "3 senior leaders"
    })
    $("#seniorLeaders-4").on('click', function () {
        selectSeniorLeaders('seniorLeaders-4')
        assessmentAnswers.seniorLeaders = "4 senior leaders"
    })
    $("#seniorLeaders-5").on('click', function () {
        selectSeniorLeaders('seniorLeaders-5')
        assessmentAnswers.seniorLeaders = "5 senior leaders"
    })
    $("#seniorLeaders-6").on('click', function () {
        selectSeniorLeaders('seniorLeaders-6')
        assessmentAnswers.seniorLeaders = "6 senior leaders"
    })
    $("#seniorLeaders-7").on('click', function () {
        selectSeniorLeaders('seniorLeaders-7')
        assessmentAnswers.seniorLeaders = "7 senior leaders"
    })
    $("#seniorLeaders-8").on('click', function () {
        selectSeniorLeaders('seniorLeaders-8')
        assessmentAnswers.seniorLeaders = "8 senior leaders"
    })
    $("#seniorLeaders-9").on('click', function () {
        selectSeniorLeaders('seniorLeaders-9')
        assessmentAnswers.seniorLeaders = "9 senior leaders"
    })
    $("#seniorLeaders-10").on('click', function () {
        selectSeniorLeaders('seniorLeaders-10')
        assessmentAnswers.seniorLeaders = "10+ senior leaders "
    })


    // Frontline Managment func
    const selectFrontlineManagment = (el) => {
        $(`#${lastFrontlineManagment}`).addClass("btn-odg-color");
        $(`#${lastFrontlineManagment}`).removeClass("btn-odg-color-selected");
        $(`#${el}`).removeClass("btn-odg-color");
        $(`#${el}`).addClass("btn-odg-color-selected");

        lastFrontlineManagment = el
    }
    // Frontline Managment button group 
    $("#frontlineManagers-1").on('click', function () {
        selectFrontlineManagment('frontlineManagers-1')
        assessmentAnswers.frontlineLeaders = "0-1 frontline leaders"
    })
    $("#frontlineManagers-2").on('click', function () {
        selectFrontlineManagment('frontlineManagers-2')
        assessmentAnswers.frontlineLeaders = "2-4 frontline leaders"
    })
    $("#frontlineManagers-3").on('click', function () {
        selectFrontlineManagment('frontlineManagers-3')
        assessmentAnswers.frontlineLeaders = "5-10 frontline leaders"
    })
    $("#frontlineManagers-4").on('click', function () {
        selectFrontlineManagment('frontlineManagers-4')
        assessmentAnswers.frontlineLeaders = "11-25 frontline leaders"
    })
    $("#frontlineManagers-5").on('click', function () {
        selectFrontlineManagment('frontlineManagers-5')
        assessmentAnswers.frontlineLeaders = "26+ frontline leaders"
    })
    // Departments func
    const selectDepartments = (el) => {
        $(`#${lastDepartments}`).addClass("btn-odg-color");
        $(`#${lastDepartments}`).removeClass("btn-odg-color-selected");
        $(`#${el}`).removeClass("btn-odg-color");
        $(`#${el}`).addClass("btn-odg-color-selected");

        lastDepartments = el
    }
    // Departments button group 
    $("#departments-1").on('click', function () {
        selectDepartments('departments-1')
        assessmentAnswers.departments = "1"
    })
    $("#departments-2").on('click', function () {
        selectDepartments('departments-2')
        assessmentAnswers.departments = "2"
    })
    $("#departments-3").on('click', function () {
        selectDepartments('departments-3')
        assessmentAnswers.departments = "3"
    })
    $("#departments-4").on('click', function () {
        selectDepartments('departments-4')
        assessmentAnswers.departments = "4"
    })
    $("#departments-5").on('click', function () {
        selectDepartments('departments-5')
        assessmentAnswers.departments = "5"
    })
    $("#departments-6").on('click', function () {
        selectDepartments('departments-6')
        assessmentAnswers.departments = "6"
    })
    $("#departments-7").on('click', function () {
        selectDepartments('departments-7')
        assessmentAnswers.departments = "7"
    })
    $("#departments-8").on('click', function () {
        selectDepartments('departments-8')
        assessmentAnswers.departments = "8"
    })
    $("#departments-9").on('click', function () {
        selectDepartments('departments-9')
        assessmentAnswers.departments = "9"
    })
    $("#departments-10").on('click', function () {
        selectDepartments('departments-10')
        assessmentAnswers.departments = "10+"
    })
    // type of business func
    const selectBusiness = (el) => {
        $(`#${lastTypeOfBusiness}`).addClass("odg-icon-div");
        $(`#${lastTypeOfBusiness}`).removeClass("odg-icon-div-selected");
        $(`#${el}`).removeClass("odg-icon-div");
        $(`#${el}`).addClass("odg-icon-div-selected");

        lastTypeOfBusiness = el
    }

    // type of business button group 
    $("#business-1").on('click', function () {
        selectBusiness('business-1')
        assessmentAnswers.typeOfBusiness = "Agriculture"
    })
    $("#business-2").on('click', function () {
        selectBusiness('business-2')
        assessmentAnswers.typeOfBusiness = "Oil & Gas"
    })
    $("#business-3").on('click', function () {
        selectBusiness('business-3')
        assessmentAnswers.typeOfBusiness = "Utilities"
    })
    $("#business-4").on('click', function () {
        selectBusiness('business-4')
        assessmentAnswers.typeOfBusiness = "Construction"
    })
    $("#business-5").on('click', function () {
        selectBusiness('business-5')
        assessmentAnswers.typeOfBusiness = "Manufacturing"
    })
    $("#business-6").on('click', function () {
        selectBusiness('business-6')
        assessmentAnswers.typeOfBusiness = "Wholesale Trade"
    })
    $("#business-7").on('click', function () {
        selectBusiness('business-7')
        assessmentAnswers.typeOfBusiness = "Retail"
    })
    $("#business-8").on('click', function () {
        selectBusiness('business-8')
        assessmentAnswers.typeOfBusiness = "Transportation"
    })
    $("#business-9").on('click', function () {
        selectBusiness('business-9')
        assessmentAnswers.typeOfBusiness = "Warehousing"
    })
    $("#business-10").on('click', function () {
        selectBusiness('business-10')
        assessmentAnswers.typeOfBusiness = "Information"
    })
    $("#business-11").on('click', function () {
        selectBusiness('business-11')
        assessmentAnswers.typeOfBusiness = "Finance & Insurance"
    })
    $("#business-12").on('click', function () {
        selectBusiness('business-12')
        assessmentAnswers.typeOfBusiness = "Real Estate/Rental"
    })
    $("#business-13").on('click', function () {
        selectBusiness('business-13')
        assessmentAnswers.typeOfBusiness = "Technical Services"
    })
    $("#business-14").on('click', function () {
        selectBusiness('business-14')
        assessmentAnswers.typeOfBusiness = "Management"
    })
    $("#business-15").on('click', function () {
        selectBusiness('business-15')
        assessmentAnswers.typeOfBusiness = "Administration"
    })
    $("#business-16").on('click', function () {
        selectBusiness('business-16')
        assessmentAnswers.typeOfBusiness = "Educational"
    })
    $("#business-17").on('click', function () {
        selectBusiness('business-17')
        assessmentAnswers.typeOfBusiness = "Health Care"
    })
    $("#business-18").on('click', function () {
        selectBusiness('business-18')
        assessmentAnswers.typeOfBusiness = "Food Services"
    })
    $("#business-19").on('click', function () {
        selectBusiness('business-19')
        assessmentAnswers.typeOfBusiness = "Accommodations"
    })
    $("#business-20").on('click', function () {
        selectBusiness('business-20')
        assessmentAnswers.typeOfBusiness = "Public Administration"
    })
    $("#business-21").on('click', function () {
        selectBusiness('business-21')
        assessmentAnswers.typeOfBusiness = "Arts, Entertainment, & Recreation"
    })
    $("#business-22").on('click', function () {
        selectBusiness('business-22')
        assessmentAnswers.typeOfBusiness = "Other Services"
    })

    $(".micro-select-all-section").addClass('d-none')
    ...
    switch (assessmentAnswers.employees) {
        case "1-4 employees":
            $("#changePercentage").attr('data-percent', 100 - percentage(microNumberOfSelected, microNumberOfOptions).toFixed(2));
            break;
        case "5-200 employees":
            $("#changePercentage").attr('data-percent', 100 - percentage(smallNumberOfSelected, smallNumberOfOptions).toFixed(2));
            break;
        case "201-1000 employees":
            $("#changePercentage").attr('data-percent', 100 - percentage(medNumberOfSelected, medNumberOfOptions).toFixed(2));
            break;
        case "1001-2000 employees":
            $("#changePercentage").attr('data-percent', 100 - percentage(largeNumberOfSelected, largeNumberOfOptions).toFixed(2));
            break;
        case "2001+ employees":
            $("#changePercentage").attr('data-percent', 100 - percentage(largeNumberOfSelected, largeNumberOfOptions).toFixed(2));
            break;
    ...
    $("#onAssesmentSubmit").click(assessmentAnswers, () => {
        ...
        if (
            ...
            assessmentAnswers.typeOfBusiness === "" ||
            assessmentAnswers.yrsInBusiness === "" ||
            assessmentAnswers.seniorLeaders === "" ||
            assessmentAnswers.frontlineLeaders === "" ||
            assessmentAnswers.departments === ""
        ) {
            ...
            switch (assessmentAnswers.employees) {
                case "1-4 employees":
                    ...
                    break;
                case "5-200 employees":
                    $(".small-select-all-section").removeClass('d-none')
                    $(".micro-select-all-section").addClass('d-none')
                    $(".med-select-all-section").addClass('d-none')
                    $(".large-select-all-section").addClass('d-none')
                    break;
                case "201-1000 employees":
                    $(".med-select-all-section").removeClass('d-none')
                    $(".micro-select-all-section").addClass('d-none')
                    $(".small-select-all-section").addClass('d-none')
                    $(".large-select-all-section").addClass('d-none')
                    break;
                case "1001-2000 employees":
                    $(".large-select-all-section").removeClass('d-none')
                    $(".micro-select-all-section").addClass('d-none')
                    $(".small-select-all-section").addClass('d-none')
                    $(".med-select-all-section").addClass('d-none')
                    break;
    ...
    $("#homePageContactFormSubmit").on("click", function () {
        ...
        if ($("#formName").val() === "") {
            ...
            $("#homePageContactFormSubmit").addClass("loading")
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("#yrsInBusiness").val("")
                    $("#revenue").val("")
                    $("#homePageContactFormSubmit").removeClass("loading")
                    $("#form-results")
                        .removeClass("alert-success")
                        .removeClass("alert-danger")
                        .hide()
    ...
    $("#onForm2Submit").on("click", function () {
        ...
        if ($("#compName").val() === "") {
            alert("Please enter the company name inorder to submit the contact form")
            return
        } else if ($("#compEmail").val() === "") {
            alert("Please enter an email inorder to submit the contact form")
            return
        } else {
            $("#compName").addClass("loading")
            $.ajax({
                url: "https://formspree.io/f/mrgjpbgv",
                headers: { Accept: "application/json" },
                method: "POST",
                ...
                success: function (response) {
                    ...
                    $("#compSession").val("")
                    $("#compEmail").val("")
                    $("#onForm2Submit").removeClass("loading")
                    $("#form-results")
                        .removeClass("alert-success")
                        .removeClass("alert-danger")
                        .hide()
        ...
        if ($("#compNameData").val() === "") {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("#compSessionData").val("")
                    $("#compEmailData").val("")
                    $("#sendMessageSubmit").removeClass("loading")
                    $("#form-results")
                        .removeClass("alert-success")
                        .removeClass("alert-danger")
                        .hide()
